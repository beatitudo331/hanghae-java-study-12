...
//알맞은 코드를 넣으시오.
    class Exercise3_4{
        public static void main(String[] args){
            ...
            double numOfApples_1 = 123;
            int sizeOfBucket_1 = 10;
            double numOfBucket_1 = Math.ceil(numOfApples_1/sizeOfBucket_1);
            System.out.println("필요한 바구니의 수 :"+numOfBucket_1);
        }
    }
//예상 결과 -> 필요한 바구니의 수 :13
...
// 단, 변환값은 소수점 셋째자리에서 반올림하며, Math.round() 함수를 사용하지 않고 처리할 것!
    class Exercise3_6{
        public static void main(String[] args){
            ...
            System.out.println("Celcius:"+String.format("%.3f",celcius));
        }
    }
