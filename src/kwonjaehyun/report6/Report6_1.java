...
//b. 생성자는 객체를 생성하기 위한 것이다.//인스턴스변수의 값을 초기화해줌
...
//b. 클래스 내에서라면 어디서든 사용할 수 있다.//인스턴스 메소드에서만 사용가능
...
//a. 멤버변수는 자동 초기화되므로 초기화하지 않고도 값을 참고할 수 있다.//인스턴스,클래스변수
//b. 지역변수는 사용하기 전에 반드시 초기화해야 한다.
//c. 초기화 블럭보다 생성자가 먼저 수행된다.//초기화블럭이 먼저임
