...
public class Student {
    ...
    public String info() {
        ...
        double average = Math.round((double)total/3*10)/(double)10;
...
class PlayingCard {
    ...
    public static void main(String args[]) {
        ...
        PlayingCard.height = 180;
        PlayingCard.width = 60;
        PlayingCard card2 = new PlayingCard(1, 3);
...
class Marine {
    ...
    int hp = 60; //현재 체력
    static int weapon = 6; //모든 병사의 공격력은 같아야 하기때문.(공통적)
    static int armor = 0; //모든 병사의 방어력은 같아야 하기때문.
    void weaponUp() {
        weapon++;
    }
    void armorUp() {
