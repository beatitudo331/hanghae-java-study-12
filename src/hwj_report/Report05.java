...
class Marine {
    ...
    static int hp = 60; //현재 체력 // 이유 : 업그레이드를 하지 않은 한 고정값이어야 하기 때문이다.
    static int weapon = 6; //공격력 // 이유 : 업그레이드를 하지 않은 한 고정값이어야 하기 때문이다.
    static int armor = 0; //방어력 // 이유 : 업그레이드를 하지 않은 한 고정값이어야 하기 때문이다.
    void weaponUp() {
        weapon++;
    }
    void armorUp() {
