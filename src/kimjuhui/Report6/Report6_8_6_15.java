...
public class Report6_8_6_15 {
    /*
6-8. 다음 중 생성자에 대한 설명으로 옳지 않은 것은? (모두 고르시오)  b, c, e
...
6-9. 다음 중 this에 대한 설명으로 맞지 않은 것은? (모두 고르시오) b, d
...
6-11. 다음 중 아래의 add메서드를 올바르게 오버로딩 한 것은? (모두 고르시오) b
